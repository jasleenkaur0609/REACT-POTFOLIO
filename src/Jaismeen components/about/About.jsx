    ...
    <div className="a">
      <div className="a-left">
        ...
        <div className="a-card">
          <img
            src="https://tse4.mm.bing.net/th?id=OIP.3BPSNHN-z6du3hUcZVWQGQHaE8&pid=Api&P=0&w=232&h=154"
            alt=""
            className="a-img"
          />
        </div>
      ...
      <div className="a-right">
        ...
        I am Jaismeen Kaur. I am currently studying in 1st year of B.Tech. I
